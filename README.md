...
<div align="center">
    <img src='./screenshots/login.png' width='80%' alt='screenshot da tela de login' />
    <img src='./screenshots/cadastro.png' width='80%' alt='screenshot da tela de cadastro' />
</div>
<h3>Buscar pets por cidade e/ou raça</h3>
<div align="center">
    <img src='./screenshots/adotar.png' width='80%' alt='screenshot da tela de buscar pets' />
</div>
<h3>Ver mais informações sobre o pet</h3>
<div align="center">
    <img src='./screenshots/ver-pet.png' width='80%' alt='screenshot da tela de detalhes do pet' />
</div>
<h3>Cadastrar novo pet</h3>
<div align="center">
    <img src='./screenshots/novo-pet.png' width='80%' alt='screenshot da tela para adicionar novo pet' />
</div>
<h3>Ver os seus pets cadastrados</h3>
<div align="center">
    <img src='./screenshots/seus-pets.png' width='80%' alt='screenshot da tela de pets cadastrados' />
</div>
<h3>Mensagens de erro do sistema</h3>
<div align="center">
    <img src='./screenshots/ver-pet-adotado.png' width='80%' alt='screenshot mostrando uma mensagem de erro de que o pet já foi adotado' />
</div>
<h3>Ver solicitações de adoção<h3>
<div align="center">
    <img src='./screenshots/ver-pedido-adocao.png' width='80%' alt='screenshot da tela de pedidos de adoção' />
</div>
<h3>Acesso do administrador do sistema</h3>
<div align="center">
    <img src='./screenshots/admin.png' width='80%' alt='screenshot da tela de administrador' />
</div>
<h3>Dashboard demonstrando as adoções por raça</h3>
<div align="center">
    <img src='./screenshots/dashboard.png' width='80%' alt='screenshot da tela de dashboard' />
</div>
